                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                            ...
                                            Estamos felizes em ter você com a gente.</p>

                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                A confirmação de assinatura do seu anúncio <strong>123</strong> foi aprovada com sucesso.</p>

                                            <p style="text-align: center;">
                                                <img src="{{ asset('img/status-ads/3.png') }}" alt=""
                                                    style="width: 100%; margin: 20px auto; display: block;">
                                            </p>
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            <a href="#" class="link">Clique aqui</a> e acompanhe o status do seu anúncio.</p>
