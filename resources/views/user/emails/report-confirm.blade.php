                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                            ...
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                                Você realizou uma denúncia no nosso site, referente a empresa
                                                <b>NOME DA EMPRESA</b>. Confirme essa solicitação clicando no
                                                botão abaixou para que a nossa equpe possa realizar o processo
                                                de
                                                avaliação da denuncia.<p>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td
                                                                                    ...
                                                                                    <a href="{{ url('/?') }}"
                                                                                        target="_blank"
                                                                                        style="display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #3498db;">Confirme
                                                                                        aqui</a> </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                            ...
                            <tr>
                                <td class="content-block"
                                    ...
                                    <span class="apple-link"
                                        style="color: #999999; font-size: 12px; text-align: center;">Busca RH</span>
                                </td>
                            </tr>
                            <tr>
