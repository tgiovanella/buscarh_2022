    ...
    <div class="col-md-12">
        <div class="box">
                        ...
                        <form class="form form-search" method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-right">
                                    ...
                                    <a href="{{ route('admin.categories.index') }}" class="btn btn-warning">Limpar</a>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @actions(['item'=>$item, 'route' => 'categories','btns' => 'edit|delete'])
                                        {{-- botão de ação --}}
                                        @endactions()
                                    </td>
                                </tr>
            ...
            <div class="box-footer">
                <div class="row">
                    <!-- <div class="col-md-4 text-left">{{ $categories->links() }}</div> -->
                    <div class="col-md-7 text-right paginate-count">{!! info_pages($quotations) !!}</div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.box-footer -->
