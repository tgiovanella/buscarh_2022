...
<head>
    ...
    <title>{{ __('Busca RH Web') }} | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('adm/bower_components/admin-lte/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
    <div class="login-logo text-center">
        <a href="#"><img src="{{ asset('img/logo_rh_300.png') }}" class="img-responsive" width="40%" style="margin: 0 auto;"></a>
    </div>
...
<!-- iCheck -->
<script src="{{ asset('adm/bower_components/admin-lte/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
