        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{ route('admin.subcategories.create') }}" class="btn btn-sm btn-primary"><i
                        ...
                        <form class="form form-search" method="GET" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 text-right">
                                    ...
                                    <a href="{{ route('admin.subcategories.index') }}" class="btn btn-warning">Limpar</a>
                                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @actions(['item'=>$item, 'route' => 'subcategories','btns' => 'edit|delete'])
                                        {{-- botão de ação --}}
                                        @endactions()
                                    </td>
                                </tr>
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-4 text-left">{{ $subcategories->links() }}</div>
                    <div class="col-md-7 text-right paginate-count">{!! info_pages($subcategories) !!}</div>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.box-footer -->
