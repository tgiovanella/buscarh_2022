...
class NpsController extends Controller
{
    ...
    {
        $configCoins        = CoinsConfiguration::first();
        $candidateBuyCoins  = CandidateBuyCoins::with([
            'company' => fn ($m) => $m>with('company'),
        ])
        ->get();
        return view('admin.nps.configCoins',[
            'configCoins'       => $configCoins,
            'candidateBuyCoins' => $candidateBuyCoins
        ]);
    }
}
